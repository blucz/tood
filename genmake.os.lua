...
if platform.is('webos') then
    ...
    if arch.is('arm') then
        ...
        gccflags.Optimize = "-O2 -finline-functions -ffast-math"
        compilers.GCC_CC_FLAGS      = "-fPIC -march=armv7-a -mcpu=cortex-a8 -mfloat-abi=softfp -mfpu=neon '-L" .. translate_path_for_tool(webos_pdk_lib) .. "' '-I" .. translate_path_for_tool(webos_pdk_include) .. "' -Wl,--allow-shlib-undefined"
...
if platform.is('android') then
    ...
    compilers.GCC_CC_FLAGS      = "-march=armv7-a -mfloat-abi=softfp -mfpu=neon -Wl,--fix-cortex-a8 '--sysroot=" .. translate_path_for_tool(ndk_sysroot) .. "'"
